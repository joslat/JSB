...
// This is a sligthly refactored version from the RealtimeChatVoiceExecutor.cs file (ported from the official Azure aoai example repository)
// it is more structured to help with understanding.
